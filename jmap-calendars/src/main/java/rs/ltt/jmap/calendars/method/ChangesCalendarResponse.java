...
public class ChangesCalendarResponse extends ChangesMethodCall<Calendar> {
    public ChangesCalendarResponse(@NonNull String accountId, @NonNull String sinceState, Long maxChanges) {
