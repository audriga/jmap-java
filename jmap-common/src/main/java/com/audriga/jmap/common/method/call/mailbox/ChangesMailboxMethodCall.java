...
@RecordBuilder
public record ChangesMailboxMethodCall(
        @NonNull Arg<String> accountId,
        @NonNull Arg<String> sinceState,
        @Nullable Arg<Long> maxChanges) implements ChangesMethodCall<Mailbox> {
    ...
    public static final class Builder extends ChangesMailboxMethodCallBuilder {
        @Override
