...
import com.audriga.jmap.client.api.WebSocketClosedException;
import com.audriga.jmap.client.event.OnStateChangeListener;
import com.audriga.jmap.client.event.PushService;
import com.audriga.jmap.client.event.WebSocketPushService;
        ...
        try (var server = new MockWebServer()) {
            ...
            try (final Mua mua = Mua.builder()
                ...
                Assertions.assertTrue(
                        mailServer.hasPushEnabledWebSockets(), "No WebSockets have been enabled for push");
                ...
                Assertions.assertFalse(
                        mailServer.hasPushEnabledWebSockets(), "Some WebSockets have been enabled for push");
            }
        }
    }
