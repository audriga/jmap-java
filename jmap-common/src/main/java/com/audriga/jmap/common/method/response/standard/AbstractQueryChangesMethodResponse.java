...
@Getter
public abstract class AbstractQueryChangesMethodResponse<T extends Identifiable>
        implements QueryChangesMethodResponse<T> {
    ...
    public AbstractQueryChangesMethodResponse(
            String accountId,
