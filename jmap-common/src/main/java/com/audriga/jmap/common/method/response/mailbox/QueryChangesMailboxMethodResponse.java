...
@RecordBuilder
public record QueryChangesMailboxMethodResponse(
        String accountId,
        ...
        implements QueryChangesMethodResponse<Mailbox> {
    ...
    public static final class Builder extends QueryChangesMailboxMethodResponseBuilder {
        @Override
