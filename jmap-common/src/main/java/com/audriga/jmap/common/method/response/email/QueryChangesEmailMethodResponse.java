...
@RecordBuilder
public record QueryChangesEmailMethodResponse(
        String accountId,
        ...
        implements QueryChangesMethodResponse<Email> {
    ...
    public static final class Builder extends QueryChangesEmailMethodResponseBuilder {
        @Override
