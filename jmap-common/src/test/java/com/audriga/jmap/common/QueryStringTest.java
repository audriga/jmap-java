...
import com.audriga.jmap.common.entity.UndoStatus;
import com.audriga.jmap.common.entity.filter.*;
...
public class QueryStringTest {
    ...
    public void inMailboxOtherThan() {
        Filter<Email> a = EmailFilterCondition.builder()
                .inMailboxOtherThan(new String[] {"spam", "trash"})
                .build();
        Filter<Email> b = EmailFilterCondition.builder()
    ...
    public void complexMailboxFilterQueryString() {
        MailboxQuery a = MailboxQuery.of(FilterOperator.or(
        ...
        MailboxQuery b = MailboxQuery.of(FilterOperator.or(
                MailboxFilterCondition.builder().name("Inbox").build(),
                FilterOperator.and(
                        MailboxFilterCondition.builder().parentId("1").build(),
                        MailboxFilterCondition.builder().isSubscribed(true).build()),
    ...
    public void complexEmailSubmissionQueryString() {
        EmailSubmissionQuery a = EmailSubmissionQuery.of(FilterOperator.or(
                ...
                FilterOperator.or(
                        ...
                        EmailSubmissionFilterCondition.builder()
                                ...
                                .build())));
        EmailSubmissionQuery b = EmailSubmissionQuery.of(FilterOperator.or(
                FilterOperator.or(
                        EmailSubmissionFilterCondition.builder()
                                .emailIds(new String[] {"4", "5"})
                                .build(),
    ...
    public void simpleNotMatchEmailSubmissionQuery() {
        EmailSubmissionQuery a = EmailSubmissionQuery.of(EmailSubmissionFilterCondition.builder()
                .undoStatus(UndoStatus.PENDING)
                .build());
        EmailSubmissionQuery b = EmailSubmissionQuery.of(EmailSubmissionFilterCondition.builder()
