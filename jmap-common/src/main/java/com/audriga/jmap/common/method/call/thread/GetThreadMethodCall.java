...
@RecordBuilder
public record GetThreadMethodCall(
        @NonNull Arg<String> accountId,
        @Nullable Arg<List<String>> ids,
        @Nullable Arg<List<String>> properties) implements GetMethodCall<Thread> {
    ...
    public static final class Builder extends GetThreadMethodCallBuilder {
        @Override
