...
@RecordBuilder
public record ChangesEmailMethodResponse(
        ...
        implements ChangesMethodResponse<Email> {
    ...
    public static final class Builder extends ChangesEmailMethodResponseBuilder {
        @Override
