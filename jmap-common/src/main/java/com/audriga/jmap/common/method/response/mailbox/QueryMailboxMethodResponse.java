...
@RecordBuilder
public record QueryMailboxMethodResponse(
        String accountId,
        String queryState,
        ...
        @Nullable Long total,
        @Nullable Long limit)
        implements QueryMethodResponse<Mailbox> {
    ...
    public static final class Builder extends QueryMailboxMethodResponseBuilder {
        @Override
