...
import static com.audriga.jmap.gson.GsonUtils.NULL_SERIALIZING_GSON;
import static com.audriga.jmap.gson.GsonUtils.REGULAR_GSON;

import com.audriga.jmap.common.websocket.*;
...
public class ApiWebSocketMessageTypeAdapter extends TypeAdapter<AbstractApiWebSocketMessage> {
    ...
    public void write(final JsonWriter jsonWriter, final AbstractApiWebSocketMessage message) throws IOException {
        ...
        jsonWriter.value(message.requestId());
