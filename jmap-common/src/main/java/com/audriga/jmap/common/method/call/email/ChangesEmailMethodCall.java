...
@RecordBuilder
public record ChangesEmailMethodCall(
        @NonNull Arg<String> accountId,
        @NonNull Arg<String> sinceState,
        @Nullable Arg<Long> maxChanges) implements ChangesMethodCall<Email> {
    ...
    public static final class Builder extends ChangesEmailMethodCallBuilder {
        @Override
